  ...
  return `
    ...
    <div class="flex items-center justify-between gap-3 mb-3 bg-white p-2.5 rounded-xl border border-slate-200 shadow-2xs">
      <div class="search-box-wrap max-w-md">
        ...
        <input type="search" id="maternalSearchInput" placeholder="Search patients by name, contact, risk, barangay..." value="${escapeHtml(searchTerm)}" class="input-field text-xs">
      </div>
